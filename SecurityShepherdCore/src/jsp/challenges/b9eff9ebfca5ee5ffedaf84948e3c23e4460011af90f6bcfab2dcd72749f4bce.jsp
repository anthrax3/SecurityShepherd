...
String levelName = "Password Hashing 2";
//Alphanumeric Only
String levelHash = "b9eff9ebfca5ee5ffedaf84948e3c23e4460011af90f6bcfab2dcd72749f4bce";
//Translation Stuff
Locale locale = new Locale(Validate.validateLanguage(request.getSession()));
ResourceBundle bundle = ResourceBundle.getBundle("i18n.challenges.hashing." + levelHash, locale);
		...
		<script>
			$("#leForm").submit(function(){
				...
				$("#resultsDiv").hide("slow", function(){
					var ajaxCall = $.ajax({
						type: "POST",
						url: "f72c30f723cbd892e16cb1bcc64c0d345a10058f6bce3d81dd4ead9a4f9cd504",
						data: {
